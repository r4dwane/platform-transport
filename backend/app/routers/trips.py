...
from app.models.load import StatutCharge, GeoPoint
...
# ─────────────────────────────────────────────
#  GET /api/v1/trips/my/trips  — Driver or Client sees their trips
# ─────────────────────────────────────────────
...
@router.post(
    "/{trip_id}/advance",
    summary="Avancer le statut du trajet (chauffeur)"
)
...
@router.post(
    "/{trip_id}/location",
    summary="Mettre à jour la position GPS (chauffeur)"
)
async def update_location(
    ...
    # Append to tracking history + update vehicle position
...
# ─────────────────────────────────────────────
#  POST /api/v1/trips/{trip_id}/proof  — Driver uploads proof of delivery URL
# ─────────────────────────────────────────────
...
@router.post(
    "/{trip_id}/proof",
    summary="Soumettre la preuve de livraison (chauffeur)"
)
